...
namespace MobilePoll.Web.Api.Filters
{
    ...
    public sealed class LoggingFilterAttribute : ActionFilterAttribute
    {
        ...
        {
            Logger.Info("Action executing: {0} {1}", actionContext.Request.Method, actionContext.Request.RequestUri);
        ...
        public override void OnActionExecuted(HttpActionExecutedContext actionExecutedContext)
        {
            ...
            if (exception != null)
            {
                ...
                Logger.Error("Action executing: {0} {1} {2}", actionExecutedContext.Request.Method, actionExecutedContext.Request.RequestUri, errorMessage);
            }
            else
            {
                Logger.Info("Action completed: {0} {1} {2} {3}",
